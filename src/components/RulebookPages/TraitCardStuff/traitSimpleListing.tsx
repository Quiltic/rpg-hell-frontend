...
const theBIGList = [
    ...
    
    {
        ...
        wantedComboList: "arcane armory;|;ingredient scavenger;|;spell book;|;runic overflow;|;complex brews;|;spell manipulator;|;runic swap;|;potent alchemy;|;spell augmenter;|;placeholder;|;double dosing;|;spell expertise",
    ...
    {
        wantedLoneList: "saving face;|;heart to heart;|;first impression;|;universal language",
    ...
    },
    {
        ...
        wantedComboList: "apprentice blacksmith;|;steam power;|;abjurer;|;reforge;|;turreted item;|;spectral artillery;|;placeholder;|;placeholder;|;fractal creations;|;expert blacksmith;|;placeholder;|;wellspring of creation",
    ...
    },
    {
        ...
        wantedComboList: "nature's bind;|;knowledge of the forest;|;placeholder;|;canopy;|;marked as prey;|;plant growth;|;placeholder;|;placeholder;|;draw roots;|;warden's grasp;|;master huntsman;|;placeholder",
    ...
    },
    {
        ...
        wantedComboList: "blood magic;|;medical leaches;|;if these walls could talk;|;bloody mess;|;placeholder;|;soul absorption;|;placeholder;|;plague doctor;|;undead tinkerer;|;power from pain;|;transformative surgery;|;undead king",
    ...
    },
    {
        ...
        wantedComboList: "bully;|;marked for death;|;apprentice spell thief;|;larceny;|;silent strike;|;spell thief;|;get rough;|;placeholder;|;obscured spell;|;double headlock;|;assassinate;|;blurred spells",
