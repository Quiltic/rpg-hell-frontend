...
export default function TableOfContentsDiscl() {
    ...
    return (
        <>
          ...
          {({ open }) => (
            <>
              <Disclosure.Button className="flex justify-between px-4 py-2 text-left text-sm font-medium focus:outline-none focus-visible:ring focus-visible:ring-soul">
              ...
              <Disclosure.Panel className="px-4 pb-2 pt-4 text-sm grid grid-rows-auto-auto-auto-1fr-auto gap-4 p-4 bg-dark-400 rounded-md">
                <div className="grid grid-cols-3 p-4 gap-4">
                    <div className="bg-dark-300 capitalize whitespace-pre-wrap">
                        ...
                        <li><a href="#lock">Locking Dice</a></li>
                        <li><a href="#magic-simple">Magic</a></li>
                        <li><a href="#rest-n-travel">Rest and Travel</a>
                            <ul>
                                <li><a href="#rest">Rest</a></li>
                                <li><a href="#travel">Travel</a></li>
                            </ul>
                        </li>
                            <li><a href="#out-of-combat-rules">Out of Combat Rules</a>
                            <ul>
                        ...
                        <li><a href="#combat">Combat</a>
                            <ul>
                                <li><a href="#initiative">Initiative</a></li>
                                    <li><a href="#action-dice-ad">Action Dice (AD)</a>
                                    <ul>
                                        <li><a href="#ad-values-matter">AD Values Matter</a></li>
                                    </ul>
                                </li>
                                <li><a href="#damage-and-armor">Damage and Armor</a></li>
                                <li><a href="#deaths-door">Deaths Door</a></li>
                            </ul>
                        </li>
                        </ul>    
                    </div>
                    ...
                    <div className="bg-dark-300 flex-row capitalize whitespace-pre-wrap">
                        <ul>
                            ...
                            <li><a href="#making-a-character">Making a Character</a>
                                <ul>
                                    <li><a href="#level-1">Level 1</a></li>
                                    <li><a href="#leveling-up">Leveling Up!</a></li>
                                    <li><a href="#useful-level-table">Useful Level Table</a></li>
                                    <li><a href="#races-table">Races Table</a></li>
                                </ul>
                            </li>
                            <li><a href="#stack-effects">Stack Effects</a>
                                <ul>
                                    <li>
                                        <ul>
                                            ...
                                            <li><a href="#poisoned">Poisoned</a></li>
                                            ...
                                            <li><a href="#incorporeal">Incorporeal</a></li>
